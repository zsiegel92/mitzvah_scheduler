...
for person in people:
	...
	hdob= hebrew.from_gregorian(dob.year,dob.month,dob.day) #year,month,day (hebrew)
	...
	# bnei_bday_sat = dt_next_sat(bnei_bday)
...
# schools = sorted(list({person.get('Current Academic School') for person in people}))
